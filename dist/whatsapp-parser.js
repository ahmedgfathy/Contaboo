...
export class WhatsAppParser {
    static parseWhatsAppFile(filePath) {
    ...
    static extractPropertyData(messageText) {
    ...
    static async processAllChatFiles() {
                        ...
                        if (propertyData.transactionType === 'for_sale' || propertyData.transactionType === 'for_rent') {
                            const property = await prisma.property.create({
                                data: {
                                    ...
                                    type: propertyData.propertyType || 'other',
    ...
    static async initializeStaticData() {
...
WhatsAppParser.propertyTypeKeywords = {
    'شقه': 'apartment',
    'شقة': 'apartment',
    'قطعه ارض': 'land',
    'قطعة ارض': 'land',
...
WhatsAppParser.transactionTypeKeywords = {
    'للبيع': 'for_sale',
    'بيع': 'for_sale',
    'موجود': 'for_sale',
    'موجوده': 'for_sale',
...
WhatsAppParser.finishingKeywords = [
    'تشطيب سوبر لوكس',
    'سوبر لوكس',
    'لوكس',
    'نص تشطيب',
...
WhatsAppParser.featureKeywords = [
    'متقفله حديد',
    'متقفلة حديد',
    'ناصيه',
    'ناصية',
